...
import net.stacking.simpleStacker.listeners.MilkBucketListener;
...
public class SimpleStacker extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Only save language.yml if it doesn't exist
        ...
        // Register listener for special milk bucket handling
        getServer().getPluginManager().registerEvents(
                new MilkBucketListener(this),
                this
        );
